      ...
      <main className="flex-1 flex items-center justify-center px-4 py-10">
        <div className={`${cardClass} w-full max-w-md p-8 animate-slide-up`}>
          ...
          <form onSubmit={submitRegister} className="space-y-5">
            ...
            {form.role === 'admin' && (
              <div className="rounded-xl bg-amber-50 border border-amber-200 p-3 text-sm text-amber-700 flex items-start gap-2">
                ...
                <span>Only one admin is permitted. If an admin already exists, you must delete it first before registering a new one.</span>
              </div>
            )}
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <Link to="/" className="text-teal-600 hover:text-teal-800 font-semibold">
              Sign In
            </Link>
          </p>
        </div>
